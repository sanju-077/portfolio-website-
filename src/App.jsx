    ...
    <section id="contact" className="py-24 px-6 mb-20">
      <div className="max-w-xl mx-auto text-center">
        ...
        <p className="text-slate-400 text-lg mb-12">
          I’m still early in my journey, but I’m very curious about building new things and growing as a developer. I’m always open to opportunities — learning, collaborating, or trying something new. If you want to share an idea, ask something, or just say hi, feel free to reach out. I’ll do my best to reply!
        </p>
